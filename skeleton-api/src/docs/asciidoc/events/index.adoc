...
include::{snippets}/read-event/request-headers.adoc[]

==== 요청 필드

include::{snippets}/read-event/request-fields.adoc[]

==== 요청 예시

include::{snippets}/read-event/http-request.adoc[]

==== 응답 헤더

include::{snippets}/read-event/response-headers.adoc[]

==== 응답 필드

include::{snippets}/read-event/response-fields.adoc[]

==== 응답 예시

include::{snippets}/read-event/http-response.adoc[]
...
include::{snippets}/read-events/request-headers.adoc[]

==== 요청 필드

include::{snippets}/read-events/request-fields.adoc[]

==== 요청 예시

include::{snippets}/read-events/http-request.adoc[]

==== 응답 헤더

include::{snippets}/read-events/response-headers.adoc[]

==== 응답 필드

include::{snippets}/read-events/response-fields.adoc[]

==== 응답 예시

include::{snippets}/read-events/http-response.adoc[]
...
include::{snippets}/delete-event/request-headers.adoc[]

==== 요청 필드

include::{snippets}/delete-event/request-fields.adoc[]
